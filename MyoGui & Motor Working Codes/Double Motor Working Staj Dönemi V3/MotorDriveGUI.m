...
while ( t < T )
            ...
            z(4) = 1/(1 + exp(-W(4,:)*input1));
             ...
             if(abs(result-0)<0.0001) %FLEXION
                FX=FX+1;
                if(FX>5)
                    %% FLEXION TESPÝT EDÝLÝNCE MOTOR ADIM ATMAYA BAÞLASIN
                           ...
                           while(1)
                                 ...
                                 if(IsFirstStepExecuted)%Ýlk adým deðil ise 
                                   ...
                                   if (index == 122 && ~IsFirstStepExecuted) %Ýlk tur ise ve adým tamamlanmýþ ise.
                                        ...
                                        set (handles.text1,'String','Çalýþmaya devam ediyor...'); 
                                    end 
                                    ...
                                    %%
                                     ...
                                     if(abs(result-1)<0.0001) 
                                        FS=FS+1;
                                        if(FS>5)
                                            set (handles.text1,'String','Yumruk');
                                     ...
                                     if(abs(result-3)<0.0001) %EXTENSION
                                        EX=EX+1;
                                        if(EX>5)
                                             set (handles.text1,'String','Durma Emri!');
