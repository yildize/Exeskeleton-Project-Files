...
SafetyLimitPosition=1000; %% INITIAL MOTOR POSIZYONUNDAN MAXIMUM UZAKLAÞABÝLÝNECEK DEÐER.
...
vel = -99*ones(1,T*2000);
posRadians = -99*ones(1,T*2000);
ref = -99*ones(1,T*2000);
PosError = -99*ones(1,T*2000);
PosError_int = -99*ones(1,T*2000);
PosError_der = -99*ones(1,T*2000);
PresentCurrent = -99*ones(1,T*2000);
RevisedCurrent = -99*ones(1,T*2000);
TimeVector = -99*ones(1,T*2000);
...
tic; %MOTOR HAREKET KODU BAÞLAYINCA BÝR TÝMER SAYMAYA BAÞLIYOR.
                           ...
                           while(t<T)
                                    ...
                                    revised_current = (Kp*error) + (Ki*error_int) + (Kd*error_der);                                         
