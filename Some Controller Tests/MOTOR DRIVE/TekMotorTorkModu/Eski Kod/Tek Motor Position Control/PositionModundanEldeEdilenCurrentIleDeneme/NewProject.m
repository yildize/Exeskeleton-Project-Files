...
GoalCurrent = [ 0     1    11    11    11    11    11    10     9     8     6     6   5     4     1     1    14    28     0   -58    -3    -7    -9    -9  -9   -11   -13   -12   -12   -12   -11   -12   -13   -13   -12   -12  -12   -12   -11    -9   -11    -9    -9    -9    -7    -5    -2    -1  -26     0     1     4     5     3     6    10     8     8    10    12  13    11    13    14    11     0    12    10    12    12    10    10  8     9     7     5     5     4     2     1    10    28     0   -46 -4    -5    -7   -10   -10   -10   -11   -13   -12   -12   -10   -12 -13   -12   -13   -13   -13   -11   -11   -10   -11    -8    -8    -9  -8    -7    -4    -1   -22    -3     1     3     5     5     6     8  9     9    11    12    13    13    13    11     9     0    12    10  10    12    10    10     8     8     7     6     4     4     1     1  13    21     0   -55    -3    -7   -10    -7    -9   -11   -13   -13  -12];
tic; %MOTOR HAREKET KODU BAÞLAYINCA BÝR TÝMER SAYMAYA BAÞLIYOR.
                    
                           %% READ AND WRITE                                                                                                                                                                                                                                                                                                                                    
                           while(t<T && CurrentIndex<=157)
                                    ...
                                    %% WRITE GOAL CURRENT!
                                     ...
                                     write2ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID, ADDR_PRO_GOAL_CURRENT, typecast(int16(GoalCurrent(CurrentIndex)), 'uint16'));
                                        if getLastTxRxResult(port_num, PROTOCOL_VERSION) ~= COMM_SUCCESS
                                            printTxRxResult(PROTOCOL_VERSION, getLastTxRxResult(port_num, PROTOCOL_VERSION));
                                        elseif getLastRxPacketError(port_num, PROTOCOL_VERSION) ~= 0
                                            printRxPacketError(PROTOCOL_VERSION, getLastRxPacketError(port_num, PROTOCOL_VERSION));
...
hold on
plot(PresentCurrent);
legend('Goal Current', 'Present Current');
